...
import { RadixColor } from "@agreeto/api/types";
...
const AccountCard: FC<{
  ...
  const colors = Object.keys(RadixColor) as RadixColor[];
  const [container, setContainer] = React.useState<HTMLDivElement | null>(null);

  const themeColors = fullConfig.theme?.colors as Record<RadixColor, string>;
                    ...
                    return (
                      <RadioGroup.Item
                        ...
                        style={{
                          ...
                          borderColor: themeColors[color][11],
                        }}
                      >
                          ...
                          <div className="absolute bottom-[2px] right-[2px] flex">
                            <span className="inline-block w-3.5 h-3.5 -rotate-[140deg]">
                              <div
                                ...
                                style={{
                                  backgroundColor: themeColors[color][11],
                                }}
                              ></div>
                              <div
                                id="checkmark-stem"
                                className={clsx(
                                  [
                                    "w-[1px] h-[8px] absolute top-[5px] left-1.5",
                                  ],
                                  `bg-${color}-9`,
                                )}
                                style={{
                              ...
                              <div
                                id="checkmark-kick"
                                className={clsx([
                                  "w-[5px] h-[1px] absolute top-[4px] left-1.5",
                                  `bg-${color}-9`,
                                ])}
                                style={{
                                  backgroundColor: themeColors[color][7],
